...
function HomePage(props: any) {
  ...
  return (
    ...
    >
      {backdrop}
      <FeatureIntro
        heading="Supercharged Youtube Shorts Downloader⚡️"
      ...
      <div className="flex flex-col items-center border border-gray-500 shadow-lg p-4">
        <TextField
          ...
          id="url-input"
          label="Enter or Paste Youtube Shorts Link Here"
          variant="outlined"
        />
        <Button
      ...
      {isDownloadSuccess && (
        <div className="border-2 text-center border-blue-500 shadow-sm p-4">
          <div className="flex flex-col items-center md:flex-row font-mono mb-5 justify-center">
            <h3 className="font-bold text-xl">Shorts Fetching Successful</h3>
            <img
              className="m-2"
              width="30px"
              height="30px"
      ...
      {isDownloadSuccess && (
        <div className="w-full sm:w-50px lg:w-1/2 mt-10 mb-10">
          <ReactPlayer
            ...
            volume={1}
            url={
              audioResponse.downloadableFormats[
                audioResponse.downloadableFormats.length - 1
              ].url
            }
          />
        </div>
